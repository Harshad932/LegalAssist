    ...
    <div className="app-container">
      ...
      <div className="chat-container">
        <div className="chat-header">
          ...
          <button onClick={() => navigate('/client/cases')} className="back-btn">
            ← Back to My Cases
          </button>
        </div>
        ...
        <div className="messages-container">
          {messages.length === 0 ? (
            <div className="empty-state">
              ...
              <p>Start your conversation with your lawyer below</p>
            </div>
          ) : (
              ...
              {Object.entries(groupedMessages).map(([date, dateMessages]) => (
                <div key={date}>
                  ...
                  {dateMessages.map((message, index) => (
                    <div 
                      key={index} 
                      className={`message ${message.senderType === 'client' ? 'outgoing' : 'incoming'}`}
                    >
                      <div className="message-bubble">
                        <div className="message-sender">
                          {message.senderType === 'client' ? 'You' : 'Lawyer'}
                        </div>
